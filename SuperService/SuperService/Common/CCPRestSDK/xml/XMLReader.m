...
+ (NSMutableDictionary *)dictionaryForXMLData:(NSData *)data error:(NSError **)error
{
    ...
    NSMutableDictionary *rootDictionary = [reader objectWithData:data options:0];
...
+ (NSMutableDictionary *)dictionaryForXMLData:(NSData *)data options:(XMLReaderOptions)options error:(NSError **)error
{
    XMLReader *reader = [[XMLReader alloc] initWithError:error];
    NSMutableDictionary *rootDictionary = [reader objectWithData:data options:options];
    return rootDictionary;
}

+ (NSMutableDictionary *)dictionaryForXMLString:(NSString *)string options:(XMLReaderOptions)options error:(NSError **)error
{
    NSData *data = [string dataUsingEncoding:NSUTF8StringEncoding];
...
- (NSMutableDictionary *)objectWithData:(NSData *)data options:(XMLReaderOptions)options
{
    ...
    if (success)
    {
        NSMutableDictionary *resultDict = [self.dictionaryStack objectAtIndex:0];
        return resultDict;
    }
