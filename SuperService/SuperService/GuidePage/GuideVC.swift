...
class GuideVC: AnimatedPagingScrollViewController {
  ...
  private func configureComment1() {
    ...
    comment1HorizontalAnimation[2] = -70
    ...
    comment1VerticalAnimation[2] = -150
  ...
  private func configureComment2() {
    ...
    comment2HorizontalAnimation[2] = -70
    ...
    comment2VerticalAnimation[2] = -120
  ...
  private func configureComment3() {
    ...
    comment3HorizontalAnimation[2] = -70
    ...
    comment3VerticalAnimation[2] = -90
  ...
  private func configureComment4() {
    ...
    comment4HorizontalAnimation[2] = -70
    ...
    comment4VerticalAnimation[2] = -60
  ...
  private func configureComment5() {
    ...
    comment5HorizontalAnimation[2] = -70
    ...
    comment5VerticalAnimation[2] = -30
  ...
  private func configureComment6() {
    ...
    comment6HorizontalAnimation[2] = -70
...
//    scrollView.addConstraint(NSLayoutConstraint(item: background, attribute: .Top, relatedBy: .Equal, toItem: contentView, attribute: .Top, multiplier: 1, constant: 0))
//    scrollView.addConstraint(NSLayoutConstraint(item: background, attribute: .Bottom, relatedBy: .Equal, toItem: contentView, attribute: .Bottom, multiplier: 1, constant: 0))
//    scrollView.addConstraint(NSLayoutConstraint(item: background, attribute: .Left, relatedBy: .Equal, toItem: contentView, attribute: .Left, multiplier: 1, constant: 0))
//    scrollView.addConstraint(NSLayoutConstraint(item: background, attribute: .Right, relatedBy: .Equal, toItem: contentView, attribute: .Right, multiplier: 1, constant: 0))
  }
